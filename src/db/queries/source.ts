export const getSavuQuery = (): string => {
  return `
    SELECT
      codex.dbo.VU.codeVU,
...
export const getVuutilQuery = (): string => {
  return `
    SELECT
      v.codeVU,
      v.codeCIS,
...
export const getCodexcodeAtcQuery = (): string => {
  return `
    SELECT
      libAbr AS CodeATC,
      libCourt,
...
export function getCodexpictoGrossesseQuery(): string {
  return `
    SELECT
        p.codeVU,
        p.numPresentation,
...
export function getCodexpresentationQuery(): string {
  return `
    SELECT
      p.codeVU,
      p.numPresentation,
...
export function getCodexvoieAdminQuery(): string {
  return `
    SELECT
      vva.codeVU,
      vva.codeVoie,
...
export function getDboComposantsHaumeaQuery(): string {
  return `
    SELECT
      codeVU,
      numElement,
...
export function getDboContactHaumeaQuery(): string {
  return `
    SELECT
      codeContact,
      codePays,
...
export function getDboDossierHaumeaQuery(): string {
  return `
    SELECT
      codeVU,
      codeDossier,
...
export function getDboNomsSubstanceHaumeaQuery(): string {
  return `
    SELECT
      codeNomSubstance,
      codeSubstance,
...
export function getDboVuHaumeaQuery(): string {
  return `
    SELECT
      codeVU,
      codeCIS,
...
export function getDboVuTitulairesHaumeaQuery(): string {
  return `
    SELECT
      codeVU,
      codeContact,
...
export function getVudelivranceQuery(): string {
  return `
    SELECT
      vd.codeVU,
      vd.codeDelivrance,
...
export function getDashboardRs5CodeVUQuery(): string {
  return `
...
export function getDashboardRs5Query(codeVUs: string[]): string {
